...
void CSkeletalViewerApp::Nui_GotSkeletonAlert( )
{
    ...
    if( SkeletonFrame.SkeletonData[m_skeletonBeingTracked].eSkeletonPositionTrackingState[NUI_SKELETON_POSITION_SHOULDER_CENTER] != NUI_SKELETON_POSITION_NOT_TRACKED )
    {
        Nui_DrawSkeleton( true, &SkeletonFrame.SkeletonData[m_skeletonBeingTracked], GetDlgItem( m_hWnd, IDC_SKELETALVIEW ), m_skeletonBeingTracked );
    }
